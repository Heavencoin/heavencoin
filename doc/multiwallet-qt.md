...
In order to support loading of multiple wallets in HeavenCoin-Qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to HeavenCoin-Qt.pro.

Changes to class HeavencoinGUI
----------------------------
...
----------------------
bitcoin.cpp is the entry point into HeavenCoin-Qt, and as such, will require some minor modifications to provide hooks for
multiple wallet support. Most importantly will be the way it instantiates WalletModels and passes them to the
singleton HeavencoinGUI instance called window. Formerly, BitcoinGUI kept a pointer to a single instance of a WalletModel.
