...
#if defined(NDEBUG)
# error "Heavencoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x18c310f12700610e47f4caad7432d890d32a7d9dc5c30441a89059927a94ea85");
...
<<<<<<< HEAD
    ...
    if (nHeight == 0) {
        ...
        // Bonus reward for block 10,000 to 100,000 of 25 coins
        nSubsidy = 25 * COIN;
    } else if (nHeight < 100000) {
        // Bonus reward for block 400,000 - 800,000 of 50 coins
        nSubsidy = 50 * COIN;
...
static const int64 nTargetTimespan = 10 * 30;// Heavencoin: 5minuts
static const int64 nTargetSpacing = 1 * 30; // Heavencoin: 30 seconds
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x18c310f12700610e47f4caad7432d890d32a7d9dc5c30441a89059927a94ea85");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("141284710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1504940578;
        ...
        assert(block.hashMerkleRoot == uint256("0x63f6d9752b57b7d90c293f5b0b4db3dc3ef8c9dc338452da00d3afce1b8b3fbb"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Heavencoin: increase each by adding 2 to bitcoin's value.
