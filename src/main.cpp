...
int64 nChainStartTime = 1399640400; // Line: 2815
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        pchMessageStart[0] = 0x69; //c
        pchMessageStart[1] = 0x6A; //c
        pchMessageStart[2] = 0x75; //v
        pchMessageStart[3] = 0x40; //h
