    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a HeavenCoin address (e.g. VdNiYrYaCaXt8pVy2ygSeDaXXedz26jr15)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid HeavenCoin address"));
        }
        else
        {
